...
public class FilesInputPhylip {
     ...
     FileWriter fileInputSB = new FileWriter("executable/Inputs/inputSB");
     FileWriter fileInputProtD = new FileWriter("executable/Inputs/inputProtD");
     FileWriter fileInputNJ = new FileWriter("executable/Inputs/inputNJ");
     FileWriter fileInputCs = new FileWriter("executable/Inputs/inputCs");
